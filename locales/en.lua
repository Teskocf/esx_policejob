Locales['en'] = {
  ...
  ['not_enough_handcuff'] = 'Du hast keine entweder Handschellen oder keinen Schlüssel',
  ['id_card'] = 'ID Karte',
  ['search'] = 'Suche',
  ...
  ['softcuff'] = 'Lockere Handschellen anlegen',
  ['hardcuff'] = 'Fesseln und Fixieren',
  ['uncuff'] = 'Handschellen abnehmen',
  ['drag'] = 'Am Arm packen',
  ['out_the_vehicle'] = 'Aus den Fahrzeug holen',
  ['eupmenu'] = '----',
